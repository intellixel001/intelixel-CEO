  ...
  const cards = [
    {
      ...
      description:
        "We document every detail through stakeholder interviews, user research, and technical assessments.",
    ...
    },
    {
      ...
      description:
        "Our team creates pixel-perfect UI designs and implements robust, scalable architectures.",
    ...
    },
    {
      ...
      description:
        "We conduct rigorous QA testing and implement automated CI/CD pipelines for seamless launches.",
      ...
      <div className="relative w-full max-w-md mx-auto flex items-center justify-center">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <p className="text-gray-300 text-sm sm:text-base mb-6 sm:mb-8 flex-grow">
        ...
        {cards.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all ${
              activeCard === index ? "bg-white w-4 sm:w-6" : "bg-gray-600"
            }`}
          />
        ))}
      </div>
